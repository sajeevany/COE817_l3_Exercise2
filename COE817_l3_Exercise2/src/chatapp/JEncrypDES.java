...
public class JEncrypDES {
    ...
    public static byte[] encryptDES(String message, byte nounce, SecretKey key) {
    ...
    public static String decryptDES(byte[] encryptedMessage, int currentNounce, SecretKey key) {
